...
body <- list("resource_uri" = "e9f795a8-0146-4cf0-9bd1-c0ba3d9aa124")
...
ggplot(data = x, aes(x = date, y = numberOfInfected)) + 
  ...
  labs(title = "Number of vaccinated cases per day.",
           substitute = "2021",
           x = "Date", y = "Number of vaccinated cases")
...
ggplot(data = x, aes(x = vaccine, y = numberOfInfected)) + 
  ...
  coord_flip()+
  labs(title = "Number of vaccinated cases by the type of vaccine.",
           substitute = "2021",
           x = "Type of vaccine", y = "Number of vaccinated cases")+
...
ggplot(data = x, aes(x = ageGroup, y = numberOfInfected)) + 
  ...
  labs(title = "Number of vaccinated cases by age",
           substitute = "2021",
           x = "Age", y = "Number of vaccinated cases")+
   scale_y_continuous(expand = expansion(mult = c(0, 0.05)),labels = scales::label_number(scale = 1/10000))
```
